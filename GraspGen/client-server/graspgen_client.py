...
# Репозиторий GraspGen (родитель каталога client-server/), чтобы импортировать grasp_gen без pip install -e .
_GRASPGEN_ROOT = Path(__file__).resolve().parent.parent
