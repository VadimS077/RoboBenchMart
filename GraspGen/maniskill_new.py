...
if __name__ == "__main__":
    ...
    for json_file in json_files:
        ...
        #     0, :, :
        # ]
        xyz_scene = np.array(data["scene_info"][full_pc_key])
        ...
        if len(grasps) > 0:
            ...
            tmp = xyz_scene if xyz_scene.ndim == 2 else xyz_scene[0]
            #xyz_scene_centered = tra.transform_points(tmp, T_center)
            xyz_scene_centered = xyz_scene
